...
IMG_SIZE = 100
MODEL_PATH = r'C:\Users\Lenovo\Desktop\Projet_faciale emotion recognatiion\CNN V2\best_CNNModel.keras'
MODEL_NAME = 'CNN V2_Model'
...
while True:
    ...
    cv2.imshow('Emotion Detection - CNN V2', frame)
